...
//CHANGED--------------------------------------------------------------------------------------------------------------
function sjclWrapper(mode,string){
    ...
    if(mode==1)
        return   string.substr(0,1)+sjcl.decrypt("kdjg234cjilh3o53", string.substr(1));
    else
        return   string.substr(0,1)+sjcl.encrypt("kdjg234cjilh3o53", string.substr(1));
