...
adminController = {
    ...
    clients: [],
    init:function(preferences,io,app,express,mysql){
       ...
       this.app.use('/', express.static(preferences.serverdirectory + '/LogistikAdmin'));
        ...
        //Data Controller
       this.dataController = require('admincontroller/dataController.js');
       this.dataController.init(mysql,this);
    ...
    messageRecieved:function(socket,msg){
        ...
        if(msg.t==adminController.messageType.connection){
            ...
            if(client&&client.length>0)
              this.dataController.handleMessage(client[0],msg.data);
        }
    }
