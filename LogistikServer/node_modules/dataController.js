                            ...
                            for (var i = 0; i < rows.length; i++) {
                                ...
                                if (event.RepeatDays > 0) {
                                   ...
                                   for(var day = start;day<= end; day = day+86400000)  {
                                       ...
                                       console.log(startDiff/(86400000*event.RepeatDays))

                                       startDiff = Math.abs(startDiff)%(86400000*event.RepeatDays);
                                       ...
                                       if(startDiff>=0 && startDiff < 86400000){
                                           ...
                                           repeatEvent.Start = new Date(repeatEvent.StartMilli).yyyymmdd();
                                           ...
                                           if(repeatEvent.EndMilli>0)  {
                                              var diffStartSource =  repeatEvent.StartMilli- oldStartMilli;
                                               ...
                                               repeatEvent.End = new Date(repeatEvent.EndMilli).yyyymmdd();
                                           }
        ...
        getAllAdminNachrichten: function (callback) {
            ...
            if (data.t == this.messageType.getAll) {
                ...
                if (nachrichtenid && lieferantid) {
                    ...
                    dataController.mysqlConnection.query("UPDATE Adminlieferantnachricht SET read = 1 WHERE lieferantid = ? AND nachrichtenid = ? ", [lieferantid, nachrichtenid], function (err, result) {
                        if (err)
                            console.log("MYSQL ERROR: " + err);
                        else {
