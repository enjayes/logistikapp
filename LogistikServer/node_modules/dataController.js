...
dataController = {
    ...
    termin: {
                                ...
                                if (event.RepeatDays > 0) {
                                    ...
                                    for (var day = start; day <= end; day = day + 86400000) {
                                        ...
                                        if (startDiff >= 0 && startDiff < 86400000) {
                                            ...
                                            if (today < repeatEvent.StartMilli && repeatEvent.StartingMilli < repeatEvent.StartMilli)
        ...
        getLieferantenTermine: function (lid, callback)
        {
            ...
            dataController.mysqlConnection.query('GET FROM Termine WHERE Lieferant = ?', termin.id, function (err, result) {
                if (err)
                    console.log("MYSQL ERROR: " + err);
                else {
                callback(result);
