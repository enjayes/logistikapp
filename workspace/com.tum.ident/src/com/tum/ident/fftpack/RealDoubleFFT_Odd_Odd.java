...
public class RealDoubleFFT_Odd_Odd extends RealDoubleFFT_Even_Odd {
	...
	/**
	 * Construct a wavenumber table with size n. The sequences with the same
	 * size can share a wavenumber table. The prime factorization of <em>n</em>
	 * together with a tabulation of the trigonometric functions are computed
	 * and stored.
	 *
	 * @param n
	 ...
	 *            FFT, <em>x</em> contains the transform coeffients.
	 */
	@Override
	...
	/**
	 * Backward FFT transform of quarter wave data. It is the unnormalized
	 * inverse transform of <em>ft</em>.
	 *
	 * @param x
	 *            an array which contains the sequence to be tranformed. After
	 *            FFT, <em>x</em> contains the transform coeffients.
	 */
	@Override
	...
	/*
	 * void sinqi(int n, double wtable[]) { cosqi(n, wtable); }
	 */
}
