...
public class PAA extends TimeSeries {
	...
	/**
	 * Instantiates a new paa.
	 *
	 * @param ts the ts
	 * @param shrunkSize the shrunk size
	 */
	...
	/* 
	 * @see com.tum.ident.fastdtw.timeseries.TimeSeries#toString()
	 */
	/* 
	 * @see com.tum.ident.fastdtw.timeseries.TimeSeries#toString()
	 */
	...
	public String toString() {
		return "(" + this.originalLength + " point time series represented as "
				+ this.size() + " points)\n" + super.toString();
	} // end toString()
