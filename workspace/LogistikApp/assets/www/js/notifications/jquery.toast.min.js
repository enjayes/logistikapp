"function" != typeof Object.create && (Object.create = function (a) {
    ...
    var e = {
        ...
        setup: function () {
            var b = "";
            if (this._toastEl = this._toastEl || a("<div></div>", {"class": "jq-toast-single"}), this.options.allowToastClose && (b += '<span class="close-jq-toast-single">&times;</span>'), this.options.text instanceof Array) {
            ...
            this._toastEl.html(b), this.options.bgColor && (this._toastEl.css("background-color", this.options.bgColor), this._toastEl.css("color", this.options.textColor)), this.options.textAlign && this._toastEl.css("text-align", this.options.textAlign)
        },
        position: function () {
        ...
        addToDom: function () {
            ...
            if (0 === b.length ? (b = a("<div></div>", {"class": "jq-toast-wrap"}), a("body").append(b)) : (!this.options.stack || isNaN(parseInt(this.options.stack, 10))) && b.empty(), b.find(".jq-toast-single:hidden").remove(), b.append(this._toastEl), this.options.stack && !isNaN(parseInt(this.options.stack), 10)) {
                var c = b.find(".jq-toast-single").length, d = c - this.options.stack;
