...
$.extend($.ui.datepicker, {
	...
	iso8601Week: function(year, month, day) {
		var checkDate = (year.getFullYear ? this.newDate(year) : this.newDate(year, month, day));
		// Find Thursday of this week starting on Monday
		this.add(checkDate, 4 - (checkDate.getDay() || 7), 'd');
		return Math.floor((this.dayOfYear(checkDate) - 1) / 7) + 1;
	},
